...
public class utils {
    ...
    //private static String servidor = "http://192.168.1.128:1083/reja/rejaapi/";// En local desde otro pc
    private static String servidor = "http://192.168.56.1:1083/reja/rejaapi/";// To do desde le mismo pc
